...
void AAuraGameModeBase::SaveWorldState(UWorld* World, const FString& DestinationMapAssetName) const
{
	...
	if (ULoadScreenSaveGame* SaveGame = GetSaveSlotData(AuraGI->LoadSlotName, AuraGI->LoadSlotIndex))
	{
		if (DestinationMapAssetName != FString(""))
		{
			...
			SaveGame->MapName = GetWorldNameFromMapAssetName(DestinationMapAssetName);
		}
		...
		FSavedMap SavedMap = SaveGame->GetSavedMapWitMapName(WorldName);
...
void AAuraGameModeBase::LoadWorldState(UWorld* World) const
{
	...
	if (UGameplayStatics::DoesSaveGameExist(AuraGI->LoadSlotName, AuraGI->LoadSlotIndex))
	{
		...
		for (FActorIterator It(World); It; ++It)
		{
			...
			for (FSavedActor SavedActor : SaveGame->GetSavedMapWitMapName(WorldName).SavedActors)
			{
...
FString AAuraGameModeBase::GetWorldNameFromMapAssetName(const FString& InMapAssetName)  const 
{
	for (auto& Map :Maps)
	{
