...
void UAuraAttributeSet::HandleIncomingXP(const FEffectProperties& Props)
{
	...
	if (Props.SourceCharacter->Implements<UPlayerInterface>() && Props.SourceCharacter->Implements<UCombatInterface>())
	{
		...
		if (NumLevelUps > 0)
		{
			...
			{
				SpellPointsReward += IPlayerInterface::Execute_GetSpellPointsRewards(Props.SourceCharacter, CurrentLevel + i);
				AttributePointsReward += IPlayerInterface::Execute_GetAttributesPointsRewards(Props.SourceCharacter, CurrentLevel + i);
			}
