...
APointCollection::APointCollection()
{
	...
	Pt_1 = CreateDefaultSubobject<USceneComponent>(TEXT("Pt1"));
	ImmutablePts.Add(Pt_1);
	Pt_1->SetupAttachment(GetRootComponent());
	
	Pt_2 = CreateDefaultSubobject<USceneComponent>(TEXT("Pt2"));
	ImmutablePts.Add(Pt_2);
	Pt_2->SetupAttachment(GetRootComponent());
	
	Pt_3 = CreateDefaultSubobject<USceneComponent>(TEXT("Pt3"));
	ImmutablePts.Add(Pt_3);
	Pt_3->SetupAttachment(GetRootComponent());
	
	Pt_4 = CreateDefaultSubobject<USceneComponent>(TEXT("Pt4"));
	ImmutablePts.Add(Pt_4);
	Pt_4->SetupAttachment(GetRootComponent());
	
	Pt_5 = CreateDefaultSubobject<USceneComponent>(TEXT("Pt5"));
	ImmutablePts.Add(Pt_5);
	Pt_5->SetupAttachment(GetRootComponent());
	
	Pt_6 = CreateDefaultSubobject<USceneComponent>(TEXT("Pt6"));
	ImmutablePts.Add(Pt_6);
	Pt_6->SetupAttachment(GetRootComponent());
	
	Pt_7 = CreateDefaultSubobject<USceneComponent>(TEXT("Pt7"));
	ImmutablePts.Add(Pt_7);
	Pt_7->SetupAttachment(GetRootComponent());
	
	Pt_8 = CreateDefaultSubobject<USceneComponent>(TEXT("Pt8"));
	ImmutablePts.Add(Pt_8);
	Pt_8->SetupAttachment(GetRootComponent());
	
	Pt_9 = CreateDefaultSubobject<USceneComponent>(TEXT("Pt9"));
	ImmutablePts.Add(Pt_9);
	Pt_9->SetupAttachment(GetRootComponent());
	
	Pt_10 = CreateDefaultSubobject<USceneComponent>(TEXT("Pt10"));
